                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('books.update', $book) }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="quantity" type="text" class="form-control @error('quantity') is-invalid @enderror" name="quantity" value="{{ $book->quantity }}" required autocomplete="quantity" autofocus>
                        ...
                        <div class="row mb-3">
                            <label for="writer_id" class="col-md-4 col-form-label text-md-end">{{ __('Escritores') }}</label>
                            <div class="col-md-6">
